package com.ac.aclcp.common.modules.redis.writer;
 ...
 */
@Slf4j
public class AclcpRedisCacheWriter implements RedisCacheWriter {

    private final RedisConnectionFactory connectionFactory;
    private final Duration sleepTime;

    public AclcpRedisCacheWriter(RedisConnectionFactory connectionFactory) {
        this(connectionFactory, Duration.ZERO);
    }

    public AclcpRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
